...
class MailService {
    ...
    private async sendMail(mailOptions: { from: string, to: string, subject: string, html: string }) {
        try {
    ...
    async sendVerificationMail(receiver: string, subject: string, name: string, code: string) {
        const mailOptions = {
    ...
    async sendAccountCreationMail(receiver: string, subject: string, name: string) {
        const mailOptions = {
            from: config?.MAIL_EMAIL || '',
            to: receiver,
            subject: subject,
    ...
    async sendPasswordChangeMail(receiver: string, subject: string, name: string) {
        const mailOptions = {
            from: config?.MAIL_EMAIL || '',
            to: receiver,
            subject: subject,
